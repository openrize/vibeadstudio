...
const RULES = [
  ...
  {
    key: "saas",
    re: /(saas|software\s+as\s+a\s+service|api\b|cloud\s+platform|free\s+trial|book\s+a\s+demo|integration|workflow\s+automation|subscription\s+plan|dashboard)/i,
  },
  {
    key: "ecommerce",
  ...
  {
    key: "restaurant",
    re: /(restaurant|cafe|dining|menu|chef|reservations|order\s+online|delivery|takeout|catering)/i,
  },
  {
    key: "real_estate",
