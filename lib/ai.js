...
const CATEGORY_TEMPLATE_BUILDERS = {
  automotive: (b) => [
    {
      headline: `Explore the latest models at ${b}`,
      body: `New SUVs and sedans with advanced safety tech, quiet cabins, and the luxury details drivers expect from ${b}.`,
      cta: "Shop new inventory",
    },
    {
      headline: `Certified pre-owned you can trust — ${b}`,
      body: `Low-mileage vehicles inspected to factory standards, with warranty peace of mind and transparent history.`,
      cta: "See CPO deals",
    },
    {
      headline: `Book your test drive at ${b}`,
      body: `Feel the ride, compare trims, and get real answers from product specialists—no pressure, just the road.`,
      cta: "Schedule today",
    },
    {
      headline: `Service & parts, done right at ${b}`,
      body: `Factory-trained techs, genuine components, and scheduling that respects your calendar.`,
      cta: "Book service",
    },
  ],
  "real-estate": (b) => [
